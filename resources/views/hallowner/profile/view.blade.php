    ...
    <div class="container rounded bg-white mb-5">
        <div class="row">
            <div class="col-md-4 border-right">
                ...
                <div class="alert alert-secondary"><h4 class="text"> {{ $user->role }}</h4></div>
            </div>
            <div class="col-md-8  border-right">
                <div class="p-3 py-5">
                    ...
                    <div class="row mt-2">
                        ...
                        <div class="alert alert-secondary"><h4 class="text">Phone: <small>{{ $user->phone }} </small></h4></div>
                        <div class="alert alert-secondary"><h4 class="text">Address: <small>{{ $user->address }} </small></h4></div>
            ...
            <div class="my-3 text-center">
                ...
                <a href="{{ route('hallowner.profile.edit') }}"> <button class="btn btn-lg btn-user profile-button">Edit Profile</button></a>
